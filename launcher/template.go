...
func renderLauncherPage(cfg config.Config) string {
	r := strings.NewReplacer(
		...
		"{openai_api_key}",     html.EscapeString(cfg.OpenAIAPIKey),
		"{openai_model}",       html.EscapeString(cfg.OpenAIModel),
		"{gemini_api_key}",     html.EscapeString(cfg.GeminiAPIKey),
		"{gemini_model}",       html.EscapeString(cfg.GeminiModel),
